...
//>>excludeStart("exclude", pragmas.optimize);
 	,"lib/ui/handlebars/handlebars-ext"
//>>excludeEnd("exclude");
	 ...
	 * During build with r.js (and using grunt-croc-requirejs plugin) it pre-compiles templates and writes their code into output.
	 */
	var plug = {
